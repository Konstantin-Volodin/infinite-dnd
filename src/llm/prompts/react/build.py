...
def react_system() -> str:
    ...
    return render("react/system.jinja")


def react_context(char: Character, state: WorldState, description: str, target: str | None = None) -> str:
    """Build the REACT action-resolution context."""
